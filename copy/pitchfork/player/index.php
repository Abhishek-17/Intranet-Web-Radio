<?php
session_start();
//if(!isset($_SESSION['user']))echo "sdcsc" ;
if(!isset($_SESSION['user']) || ($_SESSION['user']!="saumya.pathak@students.iiit.ac.in" && $_SESSION['user']!="abhishek.kumar@students.iiit.ac.in" && $_SESSION['user']!="kvemuri@iiit.ac.in")) {die("you dont have permission to access this");}
