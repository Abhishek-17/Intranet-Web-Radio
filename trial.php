...
<body>
  <div id="main">
    ...
    <!-- begin header -->
    <header>
<div id="logo"><h1>IIIT<a href="#">Radio</a></br>..your music..your beat!</h1></div></br></br>
      <nav style="margin-top:30px;">
        <ul class="sf-menu" id="nav">
		  ...
		  echo"<li><a href=\"bk.php?type=announce\">Announcement</a></li>";
		  }
...
<div style="margin-top:500px;margin-left:500px;position: absolute; z-index: 1; visibility: show;" id="myElement"> </div>
 <!-- begin content -->
    <div id="site_content">
	</br>
...
<!--    <footer style="margin-top:300px;"> -->
      <p style="font-size:20px;margin-top:300px;margin-left:770px;">Copyright &copy; <a href='http:\\iiit.ac.in'>IIIT-H</a></p>
